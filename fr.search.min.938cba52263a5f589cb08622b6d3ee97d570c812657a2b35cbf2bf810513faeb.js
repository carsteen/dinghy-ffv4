...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/dinghy-ffv4/flexsearch.min.js');loadScript('/dinghy-ffv4/fr.search-data.min.e9360f0ce85f1fb0ecd9b499e71a2be2d3eb0ac4932e7591c70ea2449b09f76c.js',function(){input.required=false;search();});}
