...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/dinghy-ffv4/flexsearch.min.js');loadScript('/dinghy-ffv4/fr.search-data.min.3fc045b6a4c4d0c2f49be64e395144e3eeb8170a146376ba3d0a5b45cdc54ab9.js',function(){input.required=false;search();});}
